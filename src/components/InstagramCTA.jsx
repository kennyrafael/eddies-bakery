    ...
    <section className="relative overflow-hidden bg-void-soft py-24 px-6 sm:py-28">
      ...
      >
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-3 rounded-sm border-2 border-steel-dark px-8 py-4 font-display text-sm uppercase tracking-wide text-steel-light transition-colors duration-300 hover:border-spark hover:text-spark-bright"
        >
